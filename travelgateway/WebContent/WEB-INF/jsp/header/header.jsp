<%
	...
	String selectedPage = request.getAttribute("navigation") != null ? request.getAttribute("navigation").toString() : "";
	Boolean isHomePage = selectedPage.equals("home");
	Boolean isContactPage = selectedPage.equals("contact");
	Boolean isFlightsPage = selectedPage.equals("flights");
	Boolean isPromotionPage = selectedPage.equals("promotion");
...
<header id="main-header">
          <div class="header-top">
              <div class="container">
                  <div class="row">
                      <div class="col-md-3">
                          <h3><span class="loc-info-weather-num text-color">Delightfultours</span></h3>
                      </div>
                      <div class="col-md-3 col-md-offset-2">
                      	<a href="#"> 
                               <!-- <img class="origin round" src="img/40x40.png" alt="Image Alternative text" title="AMaze" /> -->
                              <!-- Book Online or Call Toll Free - -->
                           </a>
                        ...
                        <div class="top-user-area clearfix">
                            <ul class="top-user-area-list list list-horizontal list-border">
                                <li class="top-user-area-avatar">
                                       <!--  
                                      <h3 style="color:white">1-866-516-6660</h3> -->
        ...
        <div class="container">
            <div class="nav">
                <ul class="slimmenu" id="slimmenu">
                    <li <% if (isHomePage) { %>class="active" <%} %>><a href="<%=webAppContext%>">Home</a>
                        <!-- <ul>
                    ...
                    <li <% if (isFlightsPage) { %>class="active" <%} %>><a href="<%=flightSubmitPage%>">Flights</a>
                        <!-- <ul>
                    ...
                    <li <% if (isPromotionPage) { %>class="active" <%} %>>
                    	<a href="<%=promotionPage%>?promotion=beach">Business Class</a>
                    </li>
                    <li <% if (isContactPage) { %>class="active" <%} %>><a href="<%=contactUsPage%>">Contact Us</a>
                    </li>
